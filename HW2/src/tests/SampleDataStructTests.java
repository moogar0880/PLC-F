...
public class SampleDataStructTests {
    ...
    public static void main (String[] args) throws Exception {
        ...
        Tester tester = new Tester(SampleDataStructTests.class);
    ...
    @Test(timeout=1000,val=1) //SerialList isEmpty and size
    ...
    @Test(timeout=2000,val=1) //SerialList sort
    public void sample04 () {
        sl = new SerialList();
        for(Integer x: new Integer[] {5,2,5,7,3,8}){
            sl.add(x, x);
        }
        sl.sort();
    ...
    @Test(timeout=3000,val=1) //SerialList efficient serialization
    ...
    @Test(timeout=2000,val=1) //SerialBST find and remove
    ...
    @Test(timeout=2000,val=1) //SerialBST balance
    ...
    @Test(timeout=3000,val=1) //SerialBST efficient serialization
    ...
    @Test(timeout=2000,val=1) //SerialPrioQueue adding and order
        @SuppressWarnings("unchecked")
    ...
    @Test(timeout=4000,val=1) //SerialPrioQueue preOrder
    @SuppressWarnings("unchecked")
    ...
    @Test(timeout=3000,val=1) //SerialPrioQueue efficient serialization
    @SuppressWarnings("unchecked")
